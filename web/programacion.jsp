<%-- 
    ...
    Created on : 3/12/2020, 06:43:28 AM
    Author     : User
--%>
                ...
                <div class="vj">
                    <form method="post" action="encu_jug">
                        <select name="texttorneo" class="select-css">
                            <%
                                torneoDAO torneDAO = new torneoDAO();
                                for(torneoVO torneoVO : torneDAO.listar(id)){
                            %>
                        ...
                        <select name="textronda" class="select-css">
                            <%
                                encuentroDAO encuentrDAO = new encuentroDAO();
                                for(premioVO premioVO : encuentrDAO.ronda(id)){
                            %>
